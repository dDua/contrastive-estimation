...
def get_arguments():
    ...
    ## Basic parameters
    parser.add_argument("--dataset_path", type=str, default="/mnt/750GB/data/ropes/ropes-train-dev-v1.0/")
    parser.add_argument("--dataset_cache", default="/mnt/750GB/data/ropes/cache/")
    ...
    ## Model parameters
    parser.add_argument("--model_checkpoint", type=str, default="/mnt/750GB/data/ropes/ropes_answering_model_large/")
    ...
    parser.add_argument('--max_context_length', type=int, default=500)
    ...
    parser.add_argument('--output_prob', type=float, default=1.0)
