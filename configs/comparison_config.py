...
def get_arguments():
    ...
    ## Basic parameters
    parser.add_argument("--dataset_path", type=str, default="/mnt/750GB/data/Adversarial-MultiHopQA/data/hotpotqa/reasoning_splits/")
    ...
    parser.add_argument("--input_type", default="Q")
    parser.add_argument("--train_split_name", default="demo_train_comp")
    parser.add_argument("--dev_split_name", default="demo_dev_comp")
    parser.add_argument("--distributed", action='store_true', default=True)
    parser.add_argument("--lazy", default=True)

    ## Ablation params
    parser.add_argument("--num_cont_ans_cand", type=int, default=2)
    parser.add_argument("--num_cont_ques_cand", type=int, default=2)
    parser.add_argument("--y_only", action='store_true')

    ## Model parameters
    parser.add_argument("--model_checkpoint", type=str, default="/srv/disk00/ucinlp/ddua/data/hotpotqa/comparison_answering_large")
    ...
    parser.add_argument("--reasoning_file",
                        default="/mnt/750GB/data/Adversarial-MultiHopQA/data/hotpotqa/reasoning_splits/reasoning.json")
