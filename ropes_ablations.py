...
from configs.ropes_config import get_arguments as get_arguments_comp
from data.data_process_ropes import *
...
def train():
    ...
    dataset = dataset_class(logger, args, tokenizer, lazy=args.lazy, y_only=args.y_only, x_only=False, y_types='mine',
                            x_types='gen')
